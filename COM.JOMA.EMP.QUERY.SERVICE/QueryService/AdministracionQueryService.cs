...
{
    public class AdministracionQueryService : BaseQueryService, IAdministracionQueryService
    {
        public AdministracionQueryService(IServiceScopeFactory serviceProvider) : base(serviceProvider)
        {
        }
